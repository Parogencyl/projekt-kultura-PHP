...
<body class="d-flex flex-column min-vh-100">
    <div id="app">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto text-uppercase"
                        ...
                        <li class="nav-item text-md-left text-center mr-2">
                            <a class="nav-link pb-1" href="/projekt-kultura/admin.php/?page=main"> Aktualności </a>
                        </li>
                        <li class="nav-item text-md-left text-center mr-2">
                            <a class="nav-link pb-1" href="/projekt-kultura/admin.php/?page=coursesShop"> Szkolenia </a>
                        </li>
                        <li class="nav-item text-md-left text-center mr-2">
                            <a class="nav-link pb-1" href="/projekt-kultura/admin.php/?page=workshops"> Warsztaty </a>
                        </li>
                        <li class="nav-item text-md-left text-center mr-2">
                            <a class="nav-link pb-1" href="/projekt-kultura/admin.php/?page=teams"> Zespoły </a>
                        </li>
                        <li class="nav-item text-md-left text-center mr-2">
                            <a class="nav-link pb-1" href="/projekt-kultura/admin.php/?page=about"> Wyloguj </a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <main>
            <?php require_once("templates/adminPages/$page.php"); ?>
        </main>
    </div>
